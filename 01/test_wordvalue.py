...
class TestWordValue(unittest.TestCase):
    ...
    def test_calc_word_value(self):
        print (calc_word_value('bob'), 7,calc_word_value('JuliaN'), 13,calc_word_value('PyBites'), 14,calc_word_value('benzalphenylhydrazone'), 56)
    ...
    def test_max_word_value(self):
        print(max_word_value(TEST_WORDS), 'barbeque',max_word_value(), 'benzalphenylhydrazone')
